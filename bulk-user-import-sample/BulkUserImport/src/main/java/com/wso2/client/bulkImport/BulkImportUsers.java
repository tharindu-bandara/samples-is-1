...
public class BulkImportUsers {
    ...
    private static void executeBulkUserImport(UserAdminClient userAdminClient, String line, String fileName,
                                              String userStoreName, String defaultPassword, DataHandler file)
